...
\begin{document}
	...
	Worksheet 07 \hfill Fall 2022\\\vspace*{-0.7cm}
...
\question
Let $y = f(x)$ be the function defined by
	\begin{align*}
	f(x) = x \sqrt{6 - x} .
	\end{align*}
An answer without using the derivative or the second derivative won't be credited.
	\begin{parts}
	\part[2]
	...
	\part[3]
	Find the inflection points and the interval of concavity.
	\part[2] 
	Find the local maximum(s) and local minimum(s).
	\end{parts}
...
Find the value of the following limit:
	$$
	\displaystyle \lim_{x \ra -\infty} \frac{\sqrt{1 + 4x^6}}{2 - x^3}.
	$$
