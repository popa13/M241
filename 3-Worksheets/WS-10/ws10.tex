...
\begin{document}
	...
	Worksheet 10 \hfill Fall 2022\\\vspace*{-0.7cm}
...
\begin{multicols}{2}
	...
	\part[2]
	$\displaystyle \int x (2x + 8)^8 \, dx$.
	
	\part[2]
	$\displaystyle \int \sqrt{\cot x} \csc^2 x \, dx$.
	\part[2]
	$\displaystyle\int_0^1 (3t - 1)^{50} \, dt$.
	\part[2]
	$\displaystyle \int_0^{\sqrt{\pi}} x \cos (x^2) \, dt$.
	\end{parts}
\end{multicols}
...
\question[10]
Find the area of the region enclosed by the functions $f(x) = x^2$ and $g(x) = 4x - x^2$.
